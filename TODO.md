...
Что можно улучшить:
- Не хватает понимания почему ты рассказываешь про этот доклад и зачем тебе это
- 6-7 слайды - 1 строчка текста => можно увеличить
- performanse.mark/measure - не хватает скриншотов
- Если покопаться в настройках Node.JS Profiler - есть flame chart - можно вставить видео с переключалкой на flame chart
- TODO надо скриншоты? - надо
